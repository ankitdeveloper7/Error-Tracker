  ...
  return (
    <>
      <div className="px-8 py-[80px] flex  justify-center item-center ">
        <div className="flex flex-col item-center text-center gap-4">
          <p className="font-semibold text-xl">
            Start catching bugs before your user do.
          </p>
          <p className="text-base w-2xl">
            BugTrace helps you identify and resolve frontend and backend errors
            in real-time. No setup headaches — just add a script and go.
          </p>
